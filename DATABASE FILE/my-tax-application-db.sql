...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2023 at 10:36 AM
...
CREATE TABLE `tbl_customer` (
  ...
  `cust_county` varchar(100) NOT NULL,
  ...
  `cust_b_county` varchar(100) NOT NULL,
  ...
  `cust_s_county` varchar(100) NOT NULL,
...
INSERT INTO `tbl_customer` (`cust_id`, `cust_name`, `cust_cname`, `cust_email`, `cust_phone`, `cust_country`, `cust_address`, `cust_city`, `cust_county`, `cust_zip`, `cust_b_name`, `cust_b_cname`, `cust_b_phone`, `cust_b_country`, `cust_b_address`, `cust_b_city`, `cust_b_county`, `cust_b_zip`, `cust_s_name`, `cust_s_cname`, `cust_s_phone`, `cust_s_country`, `cust_s_address`, `cust_s_city`, `cust_s_county`, `cust_s_zip`, `cust_password`, `cust_token`, `cust_datetime`, `cust_timestamp`, `cust_status`) VALUES
...
(11, 'Gibson Murimi', 'Delas', 'gibsonmurimi4@gmail.com', '0745345678', 113, 'Delas Ave12000Nairobi', 'Nairobi', 'Nairobi', '00100', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', '827ccb0eea8a706c4c34a16891f84e7b', '2244e8ce4e0f82fe76dc0ff71fc76a2c', '2023-10-29 06:56:26', '1698587786', 1);
...
(0, 'Sony PSP', 16),
(0, 'XBox', 16),
(0, 'Car Electronics & Accessories', 6),
(0, 'Lights & Lighting Accessories', 6),
(0, 'Car Safety & Security', 6),
(0, 'MotorCycle & Powersports', 6),
(0, 'Replacement Parts', 6),
(0, 'Large Appliances', 11),
(0, 'Small Appliances', 11),
(0, 'Cooking Appliances', 11);
...
(0, 83, 1, 'The Best', 0),
(0, 84, 0, 'Best Purchase I Have ever made!', 0),
(0, 83, 1, 'Best Products!', 5),
(0, 83, 1, 'Best Products!', 4),
(0, 84, 2, 'Best Products', 3),
(0, 86, 6, 'I recommend this !', 5),
(0, 83, 1, 'Excellent product', 2),
(0, 84, 2, 'Good product', 3),
(0, 85, 3, 'Very satisfied', 4),
(0, 86, 4, 'I recommend this !', 5),
(0, 87, 5, 'Satisfactory', 2),
(0, 88, 6, 'Worth the money', 3),
(0, 89, 7, 'Highly recommended', 4),
(0, 90, 8, 'Top-notch quality', 5),
(0, 91, 9, 'Not as expected', 2),
(0, 92, 10, 'Needs improvement', 3),
(0, 93, 1, 'Great deal', 4),
(0, 94, 2, 'Perfect choice', 5),
(0, 95, 3, 'Affordable price', 2),
(0, 96, 4, 'Outstanding', 3),
(0, 97, 5, 'Very happy', 4),
(0, 98, 6, 'Impressed', 5),
(0, 99, 7, 'Good value', 2),
(0, 100, 8, 'Exceptional', 3),
(0, 101, 9, 'Incredible', 4),
(0, 102, 10, 'Unmatched', 5);
...
(1, 'slider-1.png', 'My Tax Application', 'Get to Know All the Taxes imposed to any product your buy ', 'View Women Accessories', 'product-category.php?id=4&type=mid-category', 'Center'),
...
ALTER TABLE `tbl_customer`
  ...
  ADD UNIQUE KEY `unique_email` (`cust_email`);

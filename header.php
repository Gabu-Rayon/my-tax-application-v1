...
if($cur_page == 'customer-billing-shipping-update.php') {
    ...
    <title>Update Billing and Shipping Info -
        <?php echo $meta_title_home; ?></title>
    <meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
    <meta name="description" content="<?php echo $meta_description_home; ?>">
    <?php
}
...
?>
    ...
    <script scr="https://cdnjs.cloudflare.com/ajax/libs/quagga/0.12.1/quagga.min.js"></script>
                    ...
                    <div class="left">
                        <ul>
                            <li><i class="fa fa-phone"></i>
                                <?php echo $contact_phone; ?></li>
                            <li><i class="fa fa-envelope-o"></i>
                                <?php echo $contact_email; ?></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="menu-container">
                        <div class="menu">
                            <ul>
                                ...
                                <li><a href="about.php"><?php echo $about_title; ?></a>
                                </li>
                                <li><a href="calculate-tax.php"><?php echo $calculatetax_title; ?></a>
                                </li>
                                <li><a href="faq.php"><?php echo $faq_title; ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>

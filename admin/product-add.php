...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['p_barcode'])) {
        $valid = 0;
        $error_message .= "Product Bar Code can not be empty<br>";
    }
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Product BarCode<span>*</span></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Old Price <br><span
                                    style="font-size:10px;font-weight:normal;">(In Ksh)</span></label>
                            <div class="col-sm-4">

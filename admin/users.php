                    ...
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
							...
							$statement = $pdo->prepare("SELECT * 
														...
														JOIN tbl_counties t2
														ON t1.cust_county = t2.county_id
													");
							$statement->execute();
                            ...
                            <tr class="<?php if($row['cust_status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
                                ...
                                <td>
                                    <a href="user-change-status.php?id=<?php echo $row['cust_id']; ?>"
                                        class="btn btn-success btn-xs">Change Status</a>
                                </td>
                                <td>
                                    <a href="#" class="btn btn-danger btn-xs"
                                        data-href="user-delete.php?id=<?php echo $row['cust_id']; ?>"

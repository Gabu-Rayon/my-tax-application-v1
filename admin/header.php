	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">My Tax App Admin Panel</span>
			</a>
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'service.php') ) {echo 'active';} ?>">
			          ...
			          <a href="faq.php">
						...
						<li class="treeview <?php if( ($cur_page == 'users.php') || ($cur_page == 'customer-add.php') || ($cur_page == 'customer-edit.php') ) {echo 'active';} ?>">
			          <a href="users.php">
			            <i class="fa fa-user-plus"></i> <span>Active Users</span>
			          </a>
			        </li>

...
if (isset($_POST['form1'])) {
    ...
    if (empty($_POST['cust_cname'])) {
        $valid = 0;
        $error_message .= LANG_VALUE_103."<br>";
    }
    ...
    if ($valid == 1) {
        ...
        $statement = $pdo->prepare("INSERT INTO tbl_customer (
              cust_name,cust_cname,cust_email,cust_phone,cust_county,
              cust_address,cust_town,cust_location,cust_zip,cust_b_name,
              cust_b_cname, cust_b_phone,cust_b_county,cust_b_address,
              cust_b_town,cust_b_location,cust_b_zip,cust_s_name,
              cust_s_cname,cust_s_phone,cust_s_county,cust_s_address,
              cust_s_town,cust_s_location,cust_s_zip,cust_password,
              cust_token,cust_datetime,cust_timestamp,cust_status
              ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        ...
        /*********
                ...
                unset($_POST['cust_town']);
                unset($_POST['cust_location']);
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""><?php echo "County"; ?>
                                        *</label>
                                    <select name="cust_county" class="form-control select2">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""><?php echo 'Town'; ?>
                                        *</label>
                                    <input type="text" class="form-control" name="cust_town" value="<?php if (isset($_POST['cust_town'])) {
                                        echo $_POST['cust_town'];
                                    } ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for=""><?php echo 'Location'; ?>
                                        *</label>
                                    <input type="text" class="form-control" name="cust_location" value="<?php if (isset($_POST['cust_location'])) {
                                        echo $_POST['cust_location'];
                                    } ?>">
                                </div>
                                <div class="col-md-6 form-group">
